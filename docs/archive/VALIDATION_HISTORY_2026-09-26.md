# Validation checkpoint archive — 2026-09-26

Historical snapshot captured before the mobile keyboard restoration update.
The source checkpoint for the admission/recovery release is `7943059`.
Statements about current state, pending work and CI below apply only to the
checkpoint described. Follow [current validation](../VALIDATION.md) and
[the runtime acceptance queue](../RUST_MIGRATION.md) for maintained status.
The record is preserved; relative links were adjusted for this archive location.
...
[dated validation history](VALIDATION_HISTORY_2026-09-25.md).
...
[the dated record](VALIDATION_HISTORY_2026-09-25.md#performance-evidence-and-unresolved-work).
